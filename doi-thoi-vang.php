                                ...
                                if (mysqli_num_rows($account_result) > 0) {
                                    ...
                                    if ($current_vnd >= $vnd_amount) {
                                        ...
                                        if (mysqli_num_rows($player_result) > 0) {
                                            ...
                                            $_items_bag = preg_replace('/null/', $replacement, $_items_bag, 1, $count);
                                            ...
                                            if ($count > 0) {
                                                ...
                                                // Tạo đoạn mã JavaScript để load lại trang và giữ thông báo
                                                echo '<script>';
                                                echo 'setTimeout(function() {';
                                                echo 'window.location.reload();';
                                                echo '}, 3000);'; // Thời gian chờ hiển thị thông báo (tính bằng millisecond)
                                                echo '</script>';
                                            } else {
                                                echo '<div class="text-danger pb-2 font-weight-bold">';
